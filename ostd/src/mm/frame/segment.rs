...
impl Segment {
    ...
    /// Split the segment into two at the given offset from the start.
    ///
    /// The resulting segments cannot be empty. So the offset cannot be neither
    /// zero nor the length of the segment.
    ///
    /// # Panics
    ///
